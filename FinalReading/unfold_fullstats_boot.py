...
'''
run like python unfold_fullstats.py Rapgap nominal 1 0
...
tf.random.set_seed(19874*int(sys.argv[4]))
np.random.seed(19874*int(sys.argv[4]))
...
#logfile
logfile = open("log_files/"+sys.argv[1]+"_"+sys.argv[2]+"_"+sys.argv[4]+".txt","w")

logfile.write("Running on MC sample "+sys.argv[1]+" with setting "+sys.argv[2]+" seed "+sys.argv[4]+"\n")
...
for iteration in range(5):
    ...
    plt.xscale("log")
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step1_loss.pdf",bbox_inches='tight')
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step1_eta.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_eta_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni_step1_eta)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step1_pT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_pT_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step1_dphi.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_dphi_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step1_qT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_qT_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni)
    ...
    plt.locator_params(axis='x', nbins=5)
    plt.xscale("log")
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step2_loss.pdf",bbox_inches='tight')
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step2_eta.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_eta_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni_step2_eta)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step2_pT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_pT_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni_step2_pT)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step2_dphi.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_dphi_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni_step2_dphi)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_"+sys.argv[4]+"_Step2_qT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_qT_iteration"+str(iteration)+"_"+sys.argv[4],n_Omni_step2_qT)
...
tf.keras.models.save_model(mymodel,"models/"+sys.argv[1]+"_"+sys.argv[2]+"_"+sys.argv[4])
logfile.close()
