...
#logfile
logfile = open("log_files/"+sys.argv[1]+"_"+sys.argv[2]+".txt","w")
...
#Read in the MC
mc = pd.read_pickle("/clusterfs/ml4hep/bpnachman/H1/july16/datasets/"+sys.argv[1]+"_"+sys.argv[2]+".pkl")
...
for iteration in range(5):
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step1_eta.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_eta_iteration"+str(iteration),n_Omni_step1_eta)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step1_pT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_pT_iteration"+str(iteration),n_Omni)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step1_dphi.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_dphi_iteration"+str(iteration),n_Omni)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step1_qT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step1_qT_iteration"+str(iteration),n_Omni)
    ...
    plt.locator_params(axis='x', nbins=5)
    plt.xscale("log")
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step2_loss.pdf",bbox_inches='tight')
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step2_eta.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_eta_iteration"+str(iteration),n_Omni_step2_eta)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step2_pT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_pT_iteration"+str(iteration),n_Omni_step2_pT)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step2_dphi.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_dphi_iteration"+str(iteration),n_Omni_step2_dphi)
    ...
    fig.savefig("storage_plots/"+sys.argv[1]+"_"+sys.argv[2]+"Iteration"+str(iteration)+"_Step2_qT.pdf",bbox_inches='tight')
    np.save("storage_files/"+sys.argv[1]+"_"+sys.argv[2]+"n_Omni_step2_qT_iteration"+str(iteration),n_Omni_step2_qT)
